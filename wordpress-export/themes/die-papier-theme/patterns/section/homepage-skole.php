...
<div class="wp-block-group is-style-section-white">
    ...
    <div class="wp-block-group">
        ...
        <h2 class="wp-block-heading has-secondary-color has-text-color">Skole</h2>
        <!-- /wp:heading -->
        <!-- wp:paragraph -->
        <p><a href="/skole"><strong>Alle skole →</strong></a></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    <!-- wp:query {"queryId":5,"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","taxQuery":{"category":[]},"sticky":"exclude","inherit":false},"className":"aql-category-skole"} -->
    <div class="wp-block-query aql-category-skole">
