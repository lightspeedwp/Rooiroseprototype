...
<div class="wp-block-group is-style-section-white">
    ...
    <div class="wp-block-group">
        ...
        <h2 class="wp-block-heading has-secondary-color has-text-color">Sport</h2>
        <!-- /wp:heading -->
        <!-- wp:paragraph -->
        <p><a href="/sport"><strong>Alle sport →</strong></a></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    <!-- wp:query {"queryId":4,"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","taxQuery":{"category":[]},"sticky":"exclude","inherit":false},"className":"aql-category-sport"} -->
    <div class="wp-block-query aql-category-sport">
