...
<div class="wp-block-group is-style-section-white">
    ...
    <div class="wp-block-group">
        ...
        <h2 class="wp-block-heading has-secondary-color has-text-color">Leefstyl</h2>
        <!-- /wp:heading -->
        <!-- wp:paragraph -->
        <p><a href="/leefstyl"><strong>Alle leefstyl →</strong></a></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    <!-- wp:query {"queryId":6,"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","taxQuery":{"category":[]},"sticky":"exclude","inherit":false},"className":"aql-category-leefstyl"} -->
    <div class="wp-block-query aql-category-leefstyl">
