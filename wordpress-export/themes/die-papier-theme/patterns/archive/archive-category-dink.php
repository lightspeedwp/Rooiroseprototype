<?php
/**
 * Title: Kategorie: Dink
 * Slug: die-papier/archive-category-dink
 * Categories: die-papier-archives
 * Keywords: category, kategorie, dink, opinion, menings
 * Description: Category archive page for Dink (Opinion)
 * Content from content-for-review.md lines 1647-1686 on 2026-02-28
 */
?>
...
<div class="wp-block-group alignfull is-style-section-hero-default">
    ...
    <div class="wp-block-group">
        ...
        <p class="has-text-align-center">Meningsvormende artikels, rubriek, ontledings en kommentaar.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
...
<div class="wp-block-group alignfull is-style-section-muted">
    ...
    <ul class="is-style-inline-list">
        <!-- wp:list-item -->
        <li><a href="/dink/hoofartikels">Hoofartikels</a></li>
        <!-- /wp:list-item -->
        <!-- wp:list-item -->
        <li><a href="/dink/rubrieke">Rubrieke</a></li>
        <!-- /wp:list-item -->
        <!-- wp:list-item -->
        <li><a href="/dink/briewe">Briewe</a></li>
        <!-- /wp:list-item -->
        <!-- wp:list-item -->
        <li><a href="/dink/analise">Ontledings</a></li>
        <!-- /wp:list-item -->
        <!-- wp:list-item -->
        <li><a href="/dink/kommentaar">Kommentaar</a></li>
        <!-- /wp:list-item -->
    </ul>
    <!-- /wp:list -->
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)">
    ...
    <!-- wp:query {"queryId":44,"query":{"perPage":12,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"align":"wide"} -->
