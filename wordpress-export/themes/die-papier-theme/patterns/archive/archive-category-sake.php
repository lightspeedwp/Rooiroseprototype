<?php
/**
 * Title: Kategorie: Sake
 * Slug: die-papier/archive-category-sake
 * Categories: die-papier-archives
 * Keywords: category, kategorie, sake, business
 * Description: Category archive page for Sake (Business)
 * Content from content-for-review.md lines 1496-1536 on 2026-02-28
 */
?>
...
<div class="wp-block-group alignfull is-style-section-hero-default">
    ...
    <div class="wp-block-group">
        ...
        <p class="has-text-align-center">Sakenuus en finansiële ontledings.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
...
<div class="wp-block-group alignfull is-style-section-muted">
    ...
    <ul class="is-style-inline-list">
        <!-- wp:list-item -->
        <li><a href="/sake/ekonomie">Ekonomie</a></li>
        <!-- /wp:list-item -->
        <!-- wp:list-item -->
        <li><a href="/sake/markte">Markte</a></li>
        <!-- /wp:list-item -->
        <!-- wp:list-item -->
        <li><a href="/sake/eiendom">Eiendom</a></li>
        <!-- /wp:list-item -->
        <!-- wp:list-item -->
        <li><a href="/sake/tegnologie">Tegnologie</a></li>
        <!-- /wp:list-item -->
        <!-- wp:list-item -->
        <li><a href="/sake/landbou">Landbou</a></li>
        <!-- /wp:list-item -->
    </ul>
    <!-- /wp:list -->
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)">
    ...
    <!-- wp:query {"queryId":41,"query":{"perPage":12,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"align":"wide"} -->
