...
export const Hero = () => {
  ...
  return (
    <section className="py-4 bg-gray-50 dark:bg-custom-base">
      <div className="alignwide">
        <div className="flex flex-col md:flex-row gap-6">
          
          {/* Main Hero Article - Takes up remaining space */}
          <div className="flex-1 relative group cursor-pointer">
            <ArticleLink id={mainStory.id} title={mainStory.title} className="block">
              <div className="relative h-[350px] md:h-[450px] overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 p-6 md:p-8 w-full">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <span className="bg-brand-red hover:bg-brand-red-hover text-white px-6 py-2.5 rounded font-bold transition-colors flex items-center gap-2 w-fit text-sm">
                      Lees meer
          ...
          <div className="w-full lg:w-[300px] flex-shrink-0">
            ...
            <div className="bg-white dark:bg-custom-base-2 p-6 rounded-lg border border-gray-200 dark:border-custom-base-3 h-full">
              ...
              <div className="flex flex-col gap-0 divide-y divide-gray-200 dark:divide-custom-base-3">
                {LATEST_NEWS.slice(0, 4).map((news) => (
                  <div key={news.id} className="py-3 first:pt-0 last:pb-0 group cursor-pointer">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-brand-red text-xs font-bold uppercase">{news.category}</span>
