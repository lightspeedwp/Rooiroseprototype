...
export const CompetitionCard = ({ competition }: { competition: Competition }) => {
  ...
  return (
    <Link
      ...
      className="group bg-white dark:bg-card rounded-lg border border-gray-100 dark:border-border shadow-sm dark:shadow-[var(--shadow-dark-200)] overflow-hidden hover:shadow-md transition-shadow"
    >
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-border text-xs text-gray-500 dark:text-gray-400">
          <span className="flex items-center gap-1">
            <Clock size={12} />
