...
export default function TuesdayNewsletterTemplate() {
  ...
  return (
    <NewsletterContainer title="Die Papier: Leefstyl & Nuus - 17 Desember 2025">
      {/* Header */}
      ...
      <div className="p-6 bg-gray-50 dark:bg-background">
        <h2 className="font-heading font-normal mb-2" style={{ fontVariationSettings: "var(--fvs-h2)", lineHeight: 'var(--lh-h2)', letterSpacing: 'var(--ls-h2)', fontSize: 'var(--text-h2)' }}>Hallo Zared!</h2>
      ...
      <div className="p-6">
        ...
        {topStories.map((story) => (
          <div key={story.id} className="flex gap-4 mb-6">
            ...
            />
            <div>
              <h4 className="font-heading font-normal text-sm mb-2" style={{ fontVariationSettings: "var(--fvs-h4)", lineHeight: 'var(--lh-h4)', letterSpacing: 'var(--ls-h4)' }}>{story.title}</h4>
      ...
      {/* Featured */}
      <div className="p-6">
        <h3 className="font-heading font-normal uppercase border-b border-dashed border-gray-300 pb-2 mb-4" style={{ fontVariationSettings: "var(--fvs-h3)", lineHeight: 'var(--lh-h3)', letterSpacing: 'var(--ls-h3)', fontSize: 'var(--text-h3)' }}>Uitgesonder</h3>
      ...
      {/* Catalogues */}
      <div className="p-6">
        <h3 className="font-heading font-normal uppercase border-b border-dashed border-gray-300 pb-2 mb-4" style={{ fontVariationSettings: "var(--fvs-h3)", lineHeight: 'var(--lh-h3)', letterSpacing: 'var(--ls-h3)', fontSize: 'var(--text-h3)' }}>Katalogusse</h3>
        <div className="bg-blue-900 text-white p-4 rounded text-center">
            <h4 className="font-heading font-normal mb-2" style={{ fontVariationSettings: "var(--fvs-h4)", lineHeight: 'var(--lh-h4)', letterSpacing: 'var(--ls-h4)', fontSize: 'var(--text-h4)' }}>Die uitgebreide geskenk in een boks – 'n kerswens!</h4>
      ...
      {/* E-Editions */}
      <div className="p-6 bg-gray-50 dark:bg-background">
        <h3 className="font-heading font-normal uppercase mb-4" style={{ fontVariationSettings: "var(--fvs-h3)", lineHeight: 'var(--lh-h3)', letterSpacing: 'var(--ls-h3)', fontSize: 'var(--text-h3)' }}>Jongste E-uitgawes</h3>
        <div className="bg-white p-2 shadow-sm mb-4">
             <div className="aspect-[3/4] bg-gray-200 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                    <h2 className="font-heading font-normal text-brand-red" style={{ fontVariationSettings: "var(--fvs-h2)", lineHeight: 'var(--lh-h2)', letterSpacing: 'var(--ls-h2)', fontSize: 'var(--text-h2)' }}><em>Die Papier</em></h2>
      ...
      <div className="p-6 bg-custom-base-2">
        <div className="border-2 border-dashed border-gray-400 p-4 flex items-center justify-between">
            <div>
                ...
                <div className="mt-4 flex items-center gap-2">
                    ...
                    <div className="text-xs font-bold">Rol Minder.<br/>Weet Meer!<br/>Sluit aan by <em>Die Papier</em><br/>op WhatsApp</div>
                </div>
            </div>
       ...
       <div className="p-6 bg-gray-50 dark:bg-background">
        <h3 className="font-heading font-normal mb-4" style={{ fontVariationSettings: "var(--fvs-h3)", lineHeight: 'var(--lh-h3)', letterSpacing: 'var(--ls-h3)', fontSize: 'var(--text-h3)' }}>Leefstylnuus</h3>
