...
export const PATTERNS: PatternEntry[] = [
  ...
  { id: 199, name: 'Social Profiles (Hidden)', slug: 'die-papier/hidden-social-profiles', category: 'utility', folder: 'hidden', patternCategory: 'die-papier-hidden', reactSource: 'Footer.tsx', wpFile: 'patterns/hidden/hidden-social-profiles.php', guidelinePath: 'hidden/hidden-social-profiles.md', priority: 'P1', syncType: 'Full', description: 'Core social links block with rooi rose profile URLs (Facebook, Instagram, X, YouTube, LinkedIn, TikTok). Hidden from inserter.' },
