 ...
 * for every user-facing submission form on rooi rose.
 *
...
export const FORM_EMAIL_TEMPLATES: FormEmailTemplate[] = [
  {
    ...
    subjectAf: 'Dankie vir jou boodskap — rooi rose',
    subjectEn: 'Thanks for your message — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Ons het jou navraag ontvang — rooi rose Adverteer',
    subjectEn: 'We received your enquiry — rooi rose Advertise',
  ...
  },
  {
    ...
    subjectAf: 'Jou storie is ontvang — rooi rose',
    subjectEn: 'Your story has been received — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Dankie vir jou lesersbrief — rooi rose',
    subjectEn: 'Thanks for your letter — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Jou terugvoer is ontvang — rooi rose',
    subjectEn: 'Your feedback has been received — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Jou shoutout is ontvang — rooi rose',
    subjectEn: 'Your shoutout has been received — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Jou gebeurtenis is ontvang — rooi rose',
    subjectEn: 'Your event has been received — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Welkom by rooi rose — Jou rekening is geskep',
    subjectEn: 'Welcome to rooi rose — Your account is created',
  ...
  },
  {
    ...
    subjectAf: 'Welkom by die rooi rose-nuusbrief!',
    subjectEn: 'Welcome to the rooi rose newsletter!',
  ...
  },
  {
    ...
    subjectAf: 'Jou inskrywing is ontvang — rooi rose Kompetisie',
    subjectEn: 'Your entry has been received — rooi rose Competition',
...
export const FORM_REPLY_TEMPLATES: FormReplyTemplate[] = [
  // ─ Contact replies ─
  {
    ...
    subjectAf: 'Re: Jou navraag by rooi rose — Verwysing #{ref}',
    subjectEn: 'Re: Your enquiry at rooi rose — Reference #{ref}',
    descAf: 'Persoonlike antwoord van rooi rose-span op \'n kontakvorm-navraag.',
    descEn: 'Personal reply from rooi rose team to a contact form enquiry.',
  ...
  },
  {
    ...
    subjectAf: 'rooi rose Advertensie-tariewe — Persoonlike voorstel vir {maatskappy}',
    subjectEn: 'rooi rose Advertising Rates — Custom proposal for {company}',
  ...
  // ─ Submission replies ─
  {
    ...
    subjectAf: 'Goeie nuus! Jou storie is aanvaar — rooi rose',
    subjectEn: 'Good news! Your story has been accepted — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Opdatering oor jou storie-indiening — rooi rose',
    subjectEn: 'Update on your story submission — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Jou lesersbrief is gepubliseer! — rooi rose',
    subjectEn: 'Your letter has been published! — rooi rose',
  ...
  },
  {
    ...
    subjectAf: 'Jou gebeurtenis is goedgekeur — rooi rose Kalender',
    subjectEn: 'Your event has been approved — rooi rose Calendar',
  ...
  },
  {
    ...
    subjectAf: 'Opdatering oor jou gebeurtenis-indiening — rooi rose',
    subjectEn: 'Update on your event submission — rooi rose',
  ...
  // ─ Competition reply ─
  {
    ...
    subjectAf: 'Geluk! Jy het gewen — rooi rose Kompetisie',
    subjectEn: 'Congratulations! You won — rooi rose Competition',
  ...
  // ─ Account reply ─
  {
    ...
    subjectAf: 'Herstel jou wagwoord — rooi rose',
    subjectEn: 'Reset your password — rooi rose',
  ...
  // ─ Feedback reply ─
  {
    ...
    subjectAf: 'Opdatering oor jou terugvoer — rooi rose',
    subjectEn: 'Update on your feedback — rooi rose',
  ...
  // ─ Shoutout reply ─
  {
    ...
    subjectAf: 'Jou shoutout is gepubliseer! — rooi rose',
    subjectEn: 'Your shoutout has been published! — rooi rose',
  ...
  // ─ Newsletter reply ─
  {
    ...
    subjectAf: 'Jy is suksesvol afgeteken — rooi rose Nuusbrief',
    subjectEn: 'You have been successfully unsubscribed — rooi rose Newsletter',
  ...
  // ─ Profile update reply ─
  {
    ...
    subjectAf: 'Jou profielveranderinge is gestoor — rooi rose',
    subjectEn: 'Your profile changes have been saved — rooi rose',
