import { CONTACT_EMAILS, createMailtoLink } from './contactInfo';
...
export function getArticleContent(id: number): string {
  ...
  return `
    ...
    <p class="mb-4">Vir meer inligting, kontak die redaksie by <a href="${createMailtoLink(CONTACT_EMAILS.editorial)}">${CONTACT_EMAILS.editorial}</a></p>
  `;
}