...
export const ALL_BLOCKS: BlockEntry[] = [
  ...
  { id: 'react-feature-grid', name: 'FeatureGrid', domain: 'react', category: 'home', description: 'Featured articles grid layout.', reactFile: 'FeatureGrid.tsx', reactDir: 'home', styleCount: 0, blockStyles: [], sectionStyles: ['section-white'], cssApproach: 'tailwind-inline', patterns: ['homepage-top-stories'], templates: ['front-page.html'], parts: [] },
