...
/** Custom SVG components for brand icons not in lucide-react (outline style to match Lucide) */
export const XSocialIcon: React.FC<{ size?: number; className?: string }> = ({ size = 24, className }) => (
