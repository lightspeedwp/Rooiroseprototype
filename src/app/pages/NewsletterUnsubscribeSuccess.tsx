          ...
          <div className="max-w-xl mx-auto">
            <div className="bg-white dark:bg-card rounded-lg shadow-sm border border-gray-100 dark:border-border overflow-hidden">
              ...
              <div className="bg-brand-navy p-8 text-center">
                <MailX size={48} className="mx-auto mb-4 text-gray-400" />
              ...
              <div className="p-8 md:p-10 text-center">
                <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800/40 rounded-lg p-6 mb-8 flex gap-4 items-start text-left">
